Feature: Click_Like_A_Discussion
...
@mock  
Scenario: User click like a discussion Then system update discussion's total like  
    Given Today is '2/8/2016 00:00 am'  
    When UserProfileId 'sakul@mindsage.com' click the like button discussion 'Discussion01' for comment 'Comment01' in the lesson 'Lesson01' of ClassRoom: 'ClassRoom01'  
    Then System update total likes discussion 'Discussion01' for comment 'Comment01' in the lesson 'Lesson01' of ClassRoom 'ClassRoom01' to '1' likes   
