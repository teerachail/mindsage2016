...
@mock  
Scenario: User click like a comment Then system update comment's total like  
    Given Today is '2/8/2016 00:00 am'  
    When UserProfileId 'sakul@mindsage.com' click the like button for comment 'Comment01' in the lesson 'Lesson01' of ClassRoom: 'ClassRoom01'  
    Then System update total likes for comment 'Comment01' in the lesson 'Lesson01' of ClassRoom 'ClassRoom01' to '1' likes   
